<template>
  <div class="pop-container">
    <!-- inputs -->
    <div class="pop-container--body business-form">
                ...
                >
                 <div
                  ...
                  <div class="form-group--light d-flex">
                   <label for="company_name">Company Name:<span class="color--marigold">*</span></label>
                   <Input
                     id="company_name"
               ...
               <ValidationProvider
                ...
                >
                 <div
                  ...
                  >
                  <div class="form-group--light d-flex">
                   <label for="company_name">Official VAT number (in EU)<span class="color--marigold">*</span></label>
                   <Input
                     id="company_name"
                     :value.sync="vat_no"
                     type="number"

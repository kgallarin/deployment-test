    ...
    <div class="w-100 overview-info">
      <div class="w-100 main-section section2">
        ...
        <Notification
          ...
          message="Your account has been pending your studio will be able to work after your document get confirm"
          icon="info"
          type="warning"
        >
        </Notification>
        ...
        <Tile class="mt-3 p-3 hide-on-mobile">
          ...
          <div class="d-flex p-3 align-items-end">
             <Button :click="() => ''" :pill="false" variant="light">
              <strong class="text-uppercase">Add new model</strong>
            </Button>
          </div>
        </Tile>

        <!-- Period Statistic -->
        <PeriodStatistics title="INCOME STATISTICS" />
      </div>

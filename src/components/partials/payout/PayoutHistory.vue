        ...
        <div class="table-container">
          <b-table
            ...
            :fields="windowWidth > 767 ? data = [
              ...
              { key: 'gateway', label:'Payment Method', sortable: false},
              { key: 'status', label:'Payment Status', sortable: false},
              { key: 'type', label:'Payment Type', sortable: false}
            ] :
            data = [
              { key: 'Id', thClass: 'd-none', tdClass: 'd-none' },
              { key: 'date', label:'Payment date', sortable: false},
  ...
  export default {
    computed: {
      ...
      current: {
        ...
        set(newData){
           this.$store.commit('payout_history/SET_CURRENT_PAGE', newData)
         }
      },
      ...mapGetters("payout_history", {
        payout_data: "GET_PAYOUT_HISTORY",
